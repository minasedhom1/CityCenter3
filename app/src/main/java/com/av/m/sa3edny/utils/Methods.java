...
public class Methods {
    ...
    public static String htmlRender(String ss) {
        ss=ss.replace("<span style=\"font-family: 'andale mono', times;\">","");
    ...
    public static void getFavIds(final Context context) {
        final StringRequest favrequest = new StringRequest(Request.Method.GET, Urls.URL_GET_FAVOURITES_FOR_ID+Variables.ACCOUNT_ID,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            //listener.onGetFavListSuccess(Variables.fav_ids);
