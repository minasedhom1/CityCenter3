...
public class FbCommentActivity extends AppCompatActivity {
    ...
    private static String TAG = FbCommentActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fb_commmet);
    ...
    private void loadComments() {
        ...
        String html = "<!doctype html> <html lang=\"en\"> <head></head> <body> " +
                ...
                "<div class=\"fb-comments\" data-href=\"" + "https://sodicclient.azurewebsites.net/#/Itemid?id="+231+ "\" " +
