...
public class Urls {
    ...
    public static final String SODIC_BASE="http://sa3edney.com/service/sodic/";//http://sa3edney.com/Real-EstateService/Real-Estate/";//http://sa3edney.com/service/sodic/";//"http://banksservices.azurewebsites.net/banks/";"http://laundryservices.azurewebsites.net/Laundry/";//
    public static final String SODIC_ADMIN_BASE="http://sa3edney.com/admin"; //http://sa3edney.com/Real-EstateAdmin";//http://sa3edney.com/admin";//http://sodicadmin.azurewebsites.net"http://laundryadmin.azurewebsites.net";

/*-------------------------------------------------------Sodic APIs--------------------------------------------------------*/
    public static final String URL_POST_FBID_GET_ACC_ID =SODIC_BASE+"Account/CreateAccount/Create?FBID=";
    ...
    public static final String URL_GET_FAVOURITES_FOR_ID= SODIC_BASE+"Favourite/GetFavourite/Get?AccountID=";
    ...
    public static final String URL_IMG_PATH=SODIC_ADMIN_BASE+"/IMG/";
    public static final String URL_PDF_PATH=SODIC_ADMIN_BASE+"/PDF/";
    ...
    public static String URL_POST_CLAIM_VISITS(String acc_id,String item_id,String passcode,String level) {
        return SODIC_BASE + "loyalty/visite/UseVisite?AccountID="+acc_id+"&ItemID="+item_id+"&Password="+passcode+"&LevelNo="+level;
    }


    public static final String URL_GET_ALL_CATS_AND_SUBCATS="Category/GetAllActiveCategoriesWithSubCategories/GetCategoriesWithSubCategories";
