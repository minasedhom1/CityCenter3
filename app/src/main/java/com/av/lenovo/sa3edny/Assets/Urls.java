...
public class Urls {
    ...
    public  static final  String URL_ADD_DEVICE_TOKEN="http://sodicservice.azurewebsites.net/Sodic/Device/AddDevice/Add?DeviceType=2&DeviceToken=";
    ...
    public static final String URL_GET_NOTIFICATIONS="http://sodicservice.azurewebsites.net/Sodic/Device/GetNotifications/notification";
